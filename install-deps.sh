...
curl -O http://sudachi.s3-website-ap-northeast-1.amazonaws.com/sudachidict-raw/20260116/small_lex.zip
curl -O http://sudachi.s3-website-ap-northeast-1.amazonaws.com/sudachidict-raw/20260116/core_lex.zip
curl -O http://sudachi.s3-website-ap-northeast-1.amazonaws.com/sudachidict-raw/20260116/notcore_lex.zip
